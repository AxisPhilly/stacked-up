...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SchoolAggregate'
        db.create_table('core_schoolaggregate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.School'])),
            ('likely_math_curriculum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='school_math', null=True, to=orm['curricula.Curriculum'])),
            ('likely_reading_curriculum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='school_reading', null=True, to=orm['curricula.Curriculum'])),
            ('likely_math_shortfall', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2)),
            ('likely_reading_shortfall', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal('core', ['SchoolAggregate'])


    def backwards(self, orm):
        # Deleting model 'SchoolAggregate'
        db.delete_table('core_schoolaggregate')
    ...
    models = {
        'core.schoolaggregate': {
            ...
            'likely_math_shortfall': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            ...
            'likely_reading_shortfall': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
