...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SchoolAggregate.school'
        db.add_column('core_schoolaggregate', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['schools.School']),
                      keep_default=False)

        # Adding field 'SchoolAggregate.number_of_common_materials'
        db.add_column('core_schoolaggregate', 'number_of_common_materials',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SchoolAggregate.number_of_students'
        db.add_column('core_schoolaggregate', 'number_of_students',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SchoolAggregate.number_of_common_materials'
        db.delete_column('core_schoolaggregate', 'number_of_common_materials')

        # Deleting field 'SchoolAggregate.number_of_students'
        db.delete_column('core_schoolaggregate', 'number_of_students')
    ...
    models = {
        'core.schoolaggregate': {
            ...
            'number_of_common_materials': ('django.db.models.fields.IntegerField', [], {}),
