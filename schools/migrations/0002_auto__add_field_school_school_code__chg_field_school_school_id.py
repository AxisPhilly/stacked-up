...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.school_code'
        db.add_column('schools_school', 'school_code',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True),
                      keep_default=False)


        # Changing field 'School.school_id'
        db.alter_column('schools_school', 'school_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'School.school_code'
        db.delete_column('schools_school', 'school_code')


        # Changing field 'School.school_id'
        db.alter_column('schools_school', 'school_id', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'schools.school': {
            ...
            'school_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
