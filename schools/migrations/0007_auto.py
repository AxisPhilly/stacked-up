...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field curricula_in_use on 'School'
        db.create_table('schools_school_curricula_in_use', (
        ...
        db.create_unique('schools_school_curricula_in_use', ['school_id', 'curriculum_id'])


    def backwards(self, orm):
        # Removing M2M table for field curricula_in_use on 'School'
        db.delete_table('schools_school_curricula_in_use')
    ...
    models = {
        ...
        'schools.school': {
            ...
            'curricula_in_use': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['curricula.Curriculum']", 'symmetrical': 'False'}),
