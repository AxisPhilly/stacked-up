...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publisher.group'
        db.add_column('school_data_publisher', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['school_data.PublisherGroup'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publisher.group'
        db.delete_column('school_data_publisher', 'group_id')
