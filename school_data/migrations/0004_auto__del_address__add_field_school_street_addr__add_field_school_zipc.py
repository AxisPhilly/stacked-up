...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.street_addr'
        db.add_column('school_data_school', 'street_addr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'School.zipcode'
        db.add_column('school_data_school', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'School.city'
        db.add_column('school_data_school', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'School.state'
        db.add_column('school_data_school', 'state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'School.street_addr'
        db.delete_column('school_data_school', 'street_addr')

        # Deleting field 'School.zipcode'
        db.delete_column('school_data_school', 'zipcode')

        # Deleting field 'School.city'
        db.delete_column('school_data_school', 'city')

        # Deleting field 'School.state'
        db.delete_column('school_data_school', 'state')
