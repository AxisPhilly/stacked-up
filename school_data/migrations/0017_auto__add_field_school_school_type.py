...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('school_data_school', 'school_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school_data.SchoolType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.school_type'
        db.delete_column('school_data_school', 'school_type_id')
