...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('school_data_cohort', 'math_combined_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.math_proficient_percent'
        db.alter_column('school_data_cohort', 'math_proficient_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.read_advanced_percent'
        db.alter_column('school_data_cohort', 'read_advanced_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.math_basic_percent'
        db.alter_column('school_data_cohort', 'math_basic_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.math_advanced_percent'
        db.alter_column('school_data_cohort', 'math_advanced_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.read_combined_percent'
        db.alter_column('school_data_cohort', 'read_combined_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.read_proficient_percent'
        db.alter_column('school_data_cohort', 'read_proficient_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.math_below_basic_percent'
        db.alter_column('school_data_cohort', 'math_below_basic_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.read_basic_percent'
        db.alter_column('school_data_cohort', 'read_basic_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Cohort.read_below_basic_percent'
        db.alter_column('school_data_cohort', 'read_below_basic_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Cohort.math_combined_percent'
        db.alter_column('school_data_cohort', 'math_combined_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.math_proficient_percent'
        db.alter_column('school_data_cohort', 'math_proficient_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.read_advanced_percent'
        db.alter_column('school_data_cohort', 'read_advanced_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.math_basic_percent'
        db.alter_column('school_data_cohort', 'math_basic_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.math_advanced_percent'
        db.alter_column('school_data_cohort', 'math_advanced_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.read_combined_percent'
        db.alter_column('school_data_cohort', 'read_combined_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.read_proficient_percent'
        db.alter_column('school_data_cohort', 'read_proficient_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.math_below_basic_percent'
        db.alter_column('school_data_cohort', 'math_below_basic_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.read_basic_percent'
        db.alter_column('school_data_cohort', 'read_basic_percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Cohort.read_below_basic_percent'
        db.alter_column('school_data_cohort', 'read_below_basic_percent', self.gf('django.db.models.fields.IntegerField')())
