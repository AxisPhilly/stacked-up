...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'students.cohort': {
            ...
            'associated_math_curriculum': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'math_cohort'", 'null': 'True', 'to': "orm['curricula.GradeCurriculum']"}),
            'associated_reading_curriculum': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reading_cohort'", 'null': 'True', 'to': "orm['curricula.GradeCurriculum']"}),
