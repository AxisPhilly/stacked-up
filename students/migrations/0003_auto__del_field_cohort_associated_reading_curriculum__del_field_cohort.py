...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cohort.associated_reading_curriculum'
        db.delete_column('students_cohort', 'associated_reading_curriculum_id')

        # Deleting field 'Cohort.associated_math_curriculum'
        db.delete_column('students_cohort', 'associated_math_curriculum_id')

        # Adding M2M table for field associated_reading_curriculum on 'Cohort'
        db.create_table('students_cohort_associated_reading_curriculum', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cohort', models.ForeignKey(orm['students.cohort'], null=False)),
            ('gradecurriculum', models.ForeignKey(orm['curricula.gradecurriculum'], null=False))
        ))
        db.create_unique('students_cohort_associated_reading_curriculum', ['cohort_id', 'gradecurriculum_id'])

        # Adding M2M table for field associated_math_curriculum on 'Cohort'
        db.create_table('students_cohort_associated_math_curriculum', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cohort', models.ForeignKey(orm['students.cohort'], null=False)),
            ('gradecurriculum', models.ForeignKey(orm['curricula.gradecurriculum'], null=False))
        ))
        db.create_unique('students_cohort_associated_math_curriculum', ['cohort_id', 'gradecurriculum_id'])


    def backwards(self, orm):
        # Adding field 'Cohort.associated_reading_curriculum'
        db.add_column('students_cohort', 'associated_reading_curriculum',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reading_cohort', null=True, to=orm['curricula.GradeCurriculum']),
                      keep_default=False)

        # Adding field 'Cohort.associated_math_curriculum'
        db.add_column('students_cohort', 'associated_math_curriculum',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='math_cohort', null=True, to=orm['curricula.GradeCurriculum']),
                      keep_default=False)

        # Removing M2M table for field associated_reading_curriculum on 'Cohort'
        db.delete_table('students_cohort_associated_reading_curriculum')

        # Removing M2M table for field associated_math_curriculum on 'Cohort'
        db.delete_table('students_cohort_associated_math_curriculum')
